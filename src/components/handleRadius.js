...
const UseFilter = (currentUser, currentCity, currentStreet, setLoading) => { //taking in a collection from which we want our images from
    ...
    useEffect(() => {//passing a callback function that will fire whenever the dependencies change
        const fetchData = async () => {
            if (currentUser && currentCity && currentStreet) {
